...
abstract class AbstractPlayer(val name:String, val side:String, val gem :Int, val deck : ListBuffer[AbstractCard], val hand : ListBuffer[AbstractCard])
extends Player{
